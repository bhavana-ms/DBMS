...
<body>
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <p  align="center">
  <a href="change1.php"><button >Change data</button></a>
  
  
<a href="delete1.php"><button>Delete record</button></a>
  </p>

     
              <ul class="dropdown-menu" align="center">
                <a href="logout1.php?logout"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Sign Out</a>
              </ul>
