  ...
  if( !$error ) {
   ...
   if ($res) {
   	echo '<p align="center" style="
                    font-size: 45px;
  font-family: "Segoe UI",Arial,sans-serif;"><b>Successfully Registered You may login now</b></p>';
   echo '<style>
      button{
        margin: 15px;
        padding-top: 10px;
    ...
    <p  align="center"><a href="index.php"><button>Login</button></a>';
    $errTyp = "success";
...
<div class="container" align="center">
 ...
 <div id="login-form">
   ...
   ?>
            ...
            <div class="form-group">
             <a href="index.php"><b style="color: black;">Sign in here..</b></a>
            </div>
    ...
    <p  align="center">
    <a href="p6.php"><button>Back</button></a></p>
    </div> 
